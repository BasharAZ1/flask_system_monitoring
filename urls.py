from views import homepage, CPU_Usage, Memory_Utilization, Disk_Space, Active_Processes, collect_system_info,cpu_usage_data,active_processes_data,disk_space_data,memory_utilization_data
